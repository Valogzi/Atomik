...
console.log('Serveur démarré! Testez:');
console.log('- GET http://localhost:5500/post/123');
console.log('- GET http://localhost:5500/user/456/post/789');
console.log('- GET http://localhost:5500/search/tech?q=javascript&limit=5');
